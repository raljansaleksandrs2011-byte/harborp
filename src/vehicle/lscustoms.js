...
mp.events.add('openTun', (priceModief, carModel, modelPriceModief, components, vehclass, type) => {
	...
	global.cameraRotator.start(tunCam, new mp.Vector3(-337.7784, -136.5316, 38.6032), new mp.Vector3(-337.7784, -136.5316, 38.6032), new mp.Vector3(-3.0, 3.5, 0.5), 180);
...
mp.events.add('openTun2', (priceModief, carModel, modelPriceModief, components, vehclass, type) => {
	...
	tunCam.setActive(true);
	mp.game.cam.renderScriptCams(true, true, 1500, true, false);
	global.cameraRotator.start(tunCam, new mp.Vector3(-210.76334, -1323.8368, 30.453913), new mp.Vector3(-210.76334, -1323.8368, 30.453913), new mp.Vector3(-3.0, 3.5, 0.5), 180);
	global.cameraRotator.setZBound(-0.8, 1.8);
	global.cameraRotator.setZUpMultipler(5);
	global.cameraRotator.pause(true);
	global.cameraRotator.pause(false);
