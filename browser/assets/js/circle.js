var circleDesc = {
    ...
    "park":"Припарковать авто",
	"fractotrunk": "Запихнуть в багажник",
    "fracfromtrunk": "Вытащить из багажника",
    "totrunk": "Залезть в багажник",
    "Numbers":"Снять номера",
...
var circleData = {
    ...
    "Машина":
    [
        ["hood", "trunk", "doors", "carinv", "park", "Numbers", "totrunk"],
    ],
    "Дом":
    [
