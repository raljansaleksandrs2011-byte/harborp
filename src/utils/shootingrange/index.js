...
mp.events.add("StartPoligon", () => {
    ...
    targetleft = 45;
    points = 0;
	poligonpointsmenu = mp.browsers.new("package://browser/modules/Poligon/index.html");
...
mp.events.add('OpenPedPoligon', function(lvl) {
	poligonpedmenu = mp.browsers.new("package://browser/modules/Poligon/PedMenu/index.html");
