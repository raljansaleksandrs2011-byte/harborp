...
// const playerheading = require("src/player/rotatorplayer.js");
mp.events.add('CreatorCamera', () => {
    setTimeout(function () { 
		localplayer.freezePosition(true);
		localplayer.setRotation(0.0, 0.0, 270.0, 2, true);
		...
		bodyCam = mp.cameras.new('default', new mp.Vector3(-131.0583, -634.30645, 169.40042), new mp.Vector3(0, 0, 0), 35);
		bodyCam.pointAtCoord(-132.55655, -634.21954, 168.82042 + camValues.Height);
...
function checkCamInAir() {
    if (mp.game.invoke(Natives.IS_PLAYER_SWITCH_IN_PROGRESS)) {
        ...
        if(editorBrowser == null) editorBrowser = mp.browsers.new('package://browser/modules/Character/character.html#content-1');
    }
}
