...
mp.events.add('OpenStock_EMS', () => {
    if (StockEms == null) {
        StockEms = mp.browsers.new("package://browser/modules/Fractions/EMS/Craft/index.html")
		global.menuOpen();
...
mp.events.add('OpenStock_GOV', () => {
    if (StockGov == null) {
        StockGov = mp.browsers.new("package://browser/modules/Fractions/GOV/Craft/index.html")
		global.menuOpen();
...
mp.events.add('OpenStock_LSPD', () => {
    if (StockLSPD == null) {
        StockLSPD = mp.browsers.new("package://browser/modules/Fractions/LSPD/Craft/index.html")
		global.menuOpen();
...
mp.events.add('OpenStock_FIB', () => {
    if (StockFIB == null) {
        StockFIB = mp.browsers.new("package://browser/modules/Fractions/FIB/Craft/index.html")
		global.menuOpen();
...
mp.events.add('OpenStock_GANG', () => {
    if (StockGang == null) {
        StockGang = mp.browsers.new("package://browser/modules/Fractions/GANG/Craft/index.html")
		global.menuOpen();
